...
I led the API work on [KLM's airport slot management platform](/projects/klm-airport-slot-management-automation/) for a team of around six engineers — a cloud migration of a system that gets no maintenance window, where the architecture decisions and the delivery practices were the same conversation. I was project lead on [the CMS and API behind the Dutch Single Digital Gateway programme](/projects/sdg-cms-api-development/), where the constraint was getting every municipality, province and water authority in the country publishing to one standard. I have built platform capability at [Betty Blocks](/projects/bettyblocks-low-code-platform-development/) and the Dutch access layer at [FlatPeak](/projects/flatpeak-energy-data-platform/), and I have written up [the multi-LLM stack](/posts/the-multi-llm-stack/) that came out of taking an AI product from prototype into production.
...
If you are working out which one you need, [what I take on and how engagements are shaped](/advisory/) is written up in full. Or describe the situation and I will tell you which of the two it is — including when it is neither.
